...
A [while ago](@/posts/comments-on-jekyll/index.md) I added comments for my Jekyll base blog. Since then, I switched to [zola](https://www.getzola.org/). 
...
[Previously](@/posts/comments-on-jekyll/index.md#step-1-create-a-service-that-accepts-comments) I used CGI. It's a bit archaic and cumbersome.
...
![Comment Sequence Diagram](<Sequence Diagram Comments.png>)
